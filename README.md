...
On each map folder there should be two bmp images. One named D.bmp which will be the one used during day (when the LDR detects high luminosity) and other named N.bmp which will be used at night. (Might fix the rotation issue later)
